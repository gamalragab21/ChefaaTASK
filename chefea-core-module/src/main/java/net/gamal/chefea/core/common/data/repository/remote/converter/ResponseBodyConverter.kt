package net.gamal.chefea.core.common.data.repository.remote.converter

import com.google.gson.JsonParser
import com.google.gson.stream.JsonReader
import net.gamal.chefaa.core.R
import net.gamal.chefea.android.helpers.gson.converter.INetworkFailureConverter
import net.gamal.chefea.android.helpers.gson.parsing.ResponseBodyParsingStrategy
...
internal class ResponseBodyConverter : INetworkFailureConverter {
    ...
    private fun prepareErrorBodyInternalCode(code: Int, errorBody: ResponseBody): LeonException {
        ...
        if (jsonObject.isNull(net.gamal.chefea.core.common.data.consts.Constants.CODE))
            jsonObject.put(net.gamal.chefea.core.common.data.consts.Constants.CODE, code)
